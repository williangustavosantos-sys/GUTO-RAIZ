...
// Fix: studentsForEmpresa derives from coach relationship (the correct hierarchy)
// Student → coachId → coach → empresa
...
// Patch mock students so the hierarchy is consistent:
// emp001 → c001: u001, u002, u004, u006, u008
// emp002 → c003: u009, u010  (patch coachId)
// emp003 → c002: u003, u005, u007
// emp004/005/006: sem coaches/alunos no demo
(function patchStudentCoaches() {
  const u009 = MOCK_STUDENTS.find(s => s.id === "u009");
  const u010 = MOCK_STUDENTS.find(s => s.id === "u010");
  if (u009) u009.coachId = "c003";
  if (u010) u010.coachId = "c003";
})();
